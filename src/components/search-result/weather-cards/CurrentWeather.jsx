      ...
      <div>
        ...
        <div>
          <h2 className="current-temp">
            {convertTemp((selectedWeather || currentWeather)?.main?.temp.toFixed())}
          </h2>
          <div className="min-max-temp">
            <div>
              <h3>
                {convertTemp(
                  (selectedWeather || currentWeather)?.main?.temp_min.toFixed()
                )}
              </h3>
              <p>Min</p>
            </div>
            <div>
              <h3>
                {convertTemp(
                  (selectedWeather || currentWeather)?.main?.temp_max.toFixed()
                )}
              </h3>
              <p>Max</p>
            </div>
